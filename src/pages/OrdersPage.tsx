...
// DASHBOARD + FILTROS + ITEMS + NUMERO REAL + UI MEJORADA
...
const ECOMMERCE_URL =
  "https://www.el-ecommercedcanpgroup.com";
...
export default function OrdersPage() {
  ...
  function openChat(
    ...
    navigate(
      `/inbox?phone=${encodeURIComponent(
        phone
      )}`
    );
  }
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto flex max-w-[1400px] flex-col px-6 py-10 sm:px-8 lg:px-10">
        ...
        <div className="mb-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <StatCard
            ...
            icon={DollarSign}
            valueClass="text-purple-500 text-2xl"
          />
        ...
        {loading ? (
          ...
          <div className="mx-auto grid w-full max-w-[1280px] gap-6 sm:grid-cols-2 xl:grid-cols-3">
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="mb-4 flex items-start justify-between gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p
                            className="max-w-[220px] break-all font-mono text-sm font-semibold"
                            title={
                              chatNumber
                            }
                          >
                      ...
                      <div className="mt-3 flex flex-wrap gap-1">
                        ...
                        {status !==
                          ...
                          <Button
                            size="sm"
                            variant="ghost"
                            className="h-8 px-3 text-xs text-emerald-500"
                            onClick={() =>
                              updateStatus(
                                order,
                                "cargado"
      ...
      <CardContent className="p-5">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="min-w-0">
            ...
            <p
              className={`mt-1 text-2xl font-bold leading-tight ${valueClass}`}
            >
              {value}
            </p>
