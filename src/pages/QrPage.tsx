        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="bg-card border border-border rounded-lg p-6 space-y-4">
          ...
          <div className="flex gap-2 flex-wrap">
            <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-colors">
              <QrCode className="h-4 w-4" /> Generar nuevo QR
            </button>
            <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-secondary text-secondary-foreground text-sm border border-border hover:bg-secondary/80 transition-colors">
          ...
          <div className="flex items-center gap-2 p-3 rounded-lg bg-secondary/30 text-xs text-muted-foreground">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="w-56 h-56 rounded-2xl border border-dashed border-border bg-gradient-to-b from-primary/5 to-accent/5 flex items-center justify-center">
              <div className="text-center text-sm text-muted-foreground px-4">
                ...
                Aquí se mostrará el código QR cuando generes una nueva sesión.
              </div>
            </div>
            <p className="text-xs text-muted-foreground mt-4 text-center max-w-xs">
              Si el QR no se ve claro, toca en <span className="font-medium text-foreground">Generar nuevo QR</span> o en <span className="font-medium text-foreground">Refrescar</span>.
            </p>
          </div>
        </motion.div>
      </div>
